...
- Use a proxy. See [Official Alfresco documentation](https://docs.hyland.com/r/Alfresco/Alfresco-Content-Services/25.5/Alfresco-Content-Services/Configure/Repository/Secure-Sockets-Layer-SSL-and-the-Repository/Configure-SSL-for-a-Production-Environment). 
