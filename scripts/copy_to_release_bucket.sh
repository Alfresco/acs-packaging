...
#
echo "------ Running the copy to release bucket script -------"
...
SOURCE=s3://alfresco-artefacts-staging/alfresco-content-services/snapshots/test/ek/feature/repo-4736-release_stage/1731
