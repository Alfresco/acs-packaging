...
public class ElasticsearchCMISTests extends AbstractTestNGSpringContextTests
{
    ...
    @TestRail (description = "Verify that we can return a list of fields from a document via a CMIS query against Elasticsearch.", section = TestGroup.SEARCH, executionType = ExecutionType.REGRESSION)
    @Test (groups = TestGroup.SEARCH)
    ...
    @TestRail (description = "Verify that we can return a list of fields from a folder via a CMIS query against Elasticsearch.", section = TestGroup.SEARCH, executionType = ExecutionType.REGRESSION)
    @Test (groups = TestGroup.SEARCH)
