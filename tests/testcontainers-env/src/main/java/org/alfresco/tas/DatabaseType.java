...
public enum DatabaseType
{
    ...
    MSSQL_DB("mssql", "com.microsoft.sqlserver.jdbc.SQLServerDriver", "jdbc:sqlserver://mssql:1433\\;user=sa\\;password=Alfresco1\\;databaseName=alfresco\\;lockTimeout=1000", "sa", "Alfresco1", Map.of("txn.isolation", "4096", "pool.max", "275"));
