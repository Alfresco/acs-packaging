...
public abstract class SyncServiceTest extends AbstractTestNGSpringContextTests
{
    ...
    public void setupRestClients(Method method)
    {
        ...
        restClientAlfresco.setServerPort(restProperties.envProperty().getPort());
        restClientAlfresco.configureServerEndpoint();
        restClientSyncService.setServerURI(restProperties.envProperty().getSyncServerUrl());
        restClientSyncService.setServerPort(restProperties.envProperty().getSyncPort());
