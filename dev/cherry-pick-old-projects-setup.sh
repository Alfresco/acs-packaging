...
setupRemotes alfresco-core                  support/HF/7.34.N    alfresco-community-repo core
setupRemotes alfresco-data-model            support/HF/8.50.18.N alfresco-community-repo data-model
setupRemotes alfresco-repository            support/HF/7.199.N   alfresco-community-repo repository
setupRemotes alfresco-remote-api            support/HF/7.147.N   alfresco-community-repo remote-api

setupRemotes alfresco-enterprise-repository support/HF/7.113.N   alfresco-enterprise-repo repository
setupRemotes alfresco-enterprise-remote-api support/HF/7.87.N    alfresco-enterprise-repo remote-api
setupRemotes acs-packaging                  support/HF/6.2.2     alfresco-enterprise-repo packaging
