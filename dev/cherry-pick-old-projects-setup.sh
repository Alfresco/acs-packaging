...
setupRemotes alfresco-core                  support/HF/7.5.1.N   alfresco-community-repo core
setupRemotes alfresco-data-model            support/HF/8.25.1.N  alfresco-community-repo data-model
setupRemotes alfresco-repository            support/HF/7.33.12.N alfresco-community-repo repository
setupRemotes alfresco-remote-api            support/HF/7.34.1.N  alfresco-community-repo remote-api

setupRemotes alfresco-enterprise-repository support/HF/7.25.1.N  alfresco-enterprise-repo repository
setupRemotes alfresco-enterprise-remote-api support/HF/7.20.1.N  alfresco-enterprise-repo remote-api
setupRemotes acs-packaging                  support/HF/6.1.0     alfresco-enterprise-repo packaging
