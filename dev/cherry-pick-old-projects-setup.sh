...
setupRemotes alfresco-core                  support/HF/7.5.N     alfresco-community-repo core
setupRemotes alfresco-data-model            support/HF/8.18.0.N  alfresco-community-repo data-model
setupRemotes alfresco-repository            support/HF/6.56.15.N alfresco-community-repo repository
setupRemotes alfresco-remote-api            support/HF/6.39.7.N  alfresco-community-repo remote-api

setupRemotes alfresco-enterprise-repository support/HF/6.36.8.N  alfresco-enterprise-repo repository
setupRemotes alfresco-enterprise-remote-api support/HF/6.28.N    alfresco-enterprise-repo remote-api
setupRemotes acs-packaging                  support/HF/6.0.1     alfresco-enterprise-repo packaging
