...
setupRemotes alfresco-core                  support/HF/7.3.N    alfresco-community-repo core
setupRemotes alfresco-data-model            support/HF/8.9.N    alfresco-community-repo data-model
setupRemotes alfresco-repository            support/HF/6.56.5.N alfresco-community-repo repository
setupRemotes alfresco-remote-api            support/HF/6.39.2.N alfresco-community-repo remote-api

setupRemotes alfresco-enterprise-repository support/HF/6.36.4.N alfresco-enterprise-repo repository
setupRemotes alfresco-enterprise-remote-api support/HF/6.28.3.N alfresco-enterprise-repo remote-api
setupRemotes acs-packaging                  support/HF/6.0.0    alfresco-enterprise-repo packaging
