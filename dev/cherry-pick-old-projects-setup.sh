...
setupRemotes alfresco-core                  support/HF/7.33.N    alfresco-community-repo core
...
setupRemotes acs-packaging                  support/HF/6.2.1     alfresco-enterprise-repo packaging
